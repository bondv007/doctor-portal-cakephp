...
class AttachmentsController extends AppController
{
    ...
    {
        $this->set('title_for_layout', __l('Attachments'));
    ...
    {
        $this->set('title_for_layout', __l('Add Attachment'));
        ...
        if (!empty($this->request->data)) {
            ...
            if ($this->Node->save($this->request->data)) {
                ...
                $this->Session->setFlash(__l('The Attachment has been saved') , 'default', array(
                    'class' => 'success'
                ));
                if (isset($this->request->params['named']['editor'])) {
                    $this->redirect(array(
                ...
                $this->Session->setFlash(__l('The Attachment could not be saved. Please, try again.') , 'default', array(
                    'class' => 'error'
                ));
            }
        }
    ...
    {
        $this->set('title_for_layout', __l('Edit Attachment'));
        if (!$id && empty($this->request->data)) {
            $this->Session->setFlash(__l('Invalid Attachment') , 'default', array(
                'class' => 'error'
            ));
            $this->redirect(array(
                'action' => 'index'
    ...
    {
        if (!$id) {
            $this->Session->setFlash(__l('Invalid id for Attachment') , 'default', array(
                'class' => 'error'
            ));
            $this->redirect(array(
                'action' => 'index'
        ...
        if (isset($attachment['Node'])) {
            if ($this->Node->delete($id)) {
                ...
                $this->Session->setFlash(__l('Attachment deleted') , 'default', array(
                    'class' => 'success'
                ));
                $this->redirect(array(
                    'action' => 'index'
