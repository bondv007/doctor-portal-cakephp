  	...
  	<div class="page-title-info clearfix">
		<h2 class="chart-dashboard-title ribbon-title clearfix">
      		<?php echo __l('Overview'); ?>
				<span class="js-chart-showhide <?php echo $arrow; ?> {'chart_block':'admin-dashboard-transactions', 'dataloading':'div.js-cache-load-admin-charts-transactions',  'dataurl':'admin/contest_charts/chart_transactions/is_ajax_load:1'}"></span>
		</h2>
	</div>
