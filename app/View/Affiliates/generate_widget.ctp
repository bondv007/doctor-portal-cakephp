...
<div class="form-box affiliates1-form-box clearfix">
  ...
  <div class="clearfix widget-affiliate-information-block"> 
	...
	<?php echo $this->Form->create('Affiliate', array('class' => 'normal affiliate-form clearfix js-ajax-form', 'action' => 'preview'));?>
    <h3><?php echo __l('1. Customize your widget');?></h3>
	<div class="widget-customize-block clearfix">
	...
	</div>	<h3><?php echo __l('2. Generate your widget');?></h3>
	<div class="widget-customize-block clearfix">
