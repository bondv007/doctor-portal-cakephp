...
<div class="form-box affiliates1-form-box clearfix">
...
<?php echo $this->element('user_affiliate_stat', array('cache' => array('config' => 'site_element_cache_15_min', 'key' => $this->Auth->user('id')))); ?>
...
<?php else: ?>
	...
	if($this->Auth->sessionValid()):
		echo $this->element('affiliate_request-add', array('cache' => array('config' => 'site_element_cache_1_min', 'key' => $this->Auth->user('id'))));
    endif;
    ?>
<?php endif; ?>
