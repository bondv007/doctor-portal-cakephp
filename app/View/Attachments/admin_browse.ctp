<div class="attachments index">
    ...
    <div class="actions">
        <ul>
            <li><?php echo $this->Html->link(__l('New Attachment'), array('action'=>'add', 'editor' => 1)); ?></li>
        </ul>
    </div>
    ...
    <?php
        ...
        foreach ($attachments AS $attachment) {
            ...
            $insertCode = $this->Html->link(__l('Insert'), '#', array('onclick' => 'selectURL("'.$attachment['Node']['slug'].'");'));
