 ...
 */
    public function linkDirectory($title, $path) {
        $output = $this->link($title, array('controller' => 'filemanagers', 'action' => 'browse'), $path);
        return $output;
    }
/**
 ...
 */
    public function linkFile($title, $path) {
        $output = "<a href='" . $this->Html->url(array('controller' => 'filemanagers', 'action' => 'editfile')) . "?path=" . urlencode($path) . "'>{$title}</a>";
        return $output;
    }
/**
 ...
 */
    public function linkUpload($title, $path) {
        $output = $this->link($title, array('controller' => 'filemanagers', 'action' => 'upload'), $path);
        return $output;
    }
/**
 ...
 */
    public function linkCreateDirectory($title, $path) {
        $output = $this->link($title, array('controller' => 'filemanagers', 'action' => 'new'), $path);
        return $output;
    }
/**
