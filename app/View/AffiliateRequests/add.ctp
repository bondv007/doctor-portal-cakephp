<?php /* SVN: $Id: $ */ ?>
<div class="js-preview-responses grid_left grid_16 clearfix">
<div class="affiliateRequests form">
	<h2><?php echo __l('Request Affiliate'); ?></h2>  
	<div class="form-box affiliate-request-form-box clearfix">
...
<div class="user-add-form-block">
    <div class="arequest-page-info"><?php echo __l('This request will be confirmed after admin approval.'); ?> </div>
