...
<div class="form-box">
                <div class="form-box-inner">
                   <div class="button">
                        <?php echo $this->Html->link(__l('Write Review As'), array('controller' => 'user_ratings', 'action' => 'write_review_as','0',$this->params->pass['0']), array('class' => 'review_as_box js-thickbox','style'=>'display:none', 'title' => __l('Add'))); ?>
                    </div>
...
$(document).ready(function(){
	    ...
	    click: function(score, evt) {
			...
			if(!$this->Auth->user('id')){
			 $rev=$this->Session->read('ReviewAs');?>
