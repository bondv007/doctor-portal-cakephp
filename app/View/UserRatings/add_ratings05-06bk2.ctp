...
<div class="users form js-responses">
	...
	<div class="form-box">
		...
		?>
			...
			<?php
				echo $this->Form->input('UserRating.name', array('label' => 'Name: ', 'placeholder' => 'Enter your name','required' => 'required', 'maxlength' => 100,'value' => $this->Auth->user('UserProfile.first_name')));
				...
				echo $this->Form->input('UserRating.phone', array('label' => 'Phone No: ', 'placeholder' => 'Enter your phone no', 'required' => 'required', 'maxlength' => 150)); ?>
				...
				<?php echo $this->Form->input('UserRating.review',array('label' => 'Review: ', 'maxlength' => 500, 'type' => 'textarea'));
			?>
