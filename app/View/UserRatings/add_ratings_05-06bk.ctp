...
<div class="users form js-responses">
	...
	<div class="form-box">
		...
		<div class="userRatings form form-box-inner">
			...
			<hr/>	
			<form id="UserRatingAddRatingsForm" class="normal" accept-charset="utf-8" method="post" action="<?php echo $this->webroot.'user_ratings/add_ratings'; ?>">
		<?php //echo $this->Form->create('UserRating', array('class' => 'normal'));
			echo $this->Form->input('user_id', array('type' => 'hidden', 'value' => $user['User']['id']));
		?>
			<input type="hidden" name="rate_1" id="rate_1_val" value="0"/>
			<input type="hidden" name="rate_2" id="rate_2_val" value="0"/>
			<input type="hidden" name="rate_3" id="rate_3_val" value="0"/>
			<fieldset>
			...
			<?php
				echo $this->Form->input('name', array('label' => 'Name: ', 'placeholder' => 'Enter your name','required' => 'required', 'maxlength' => 100));
				echo $this->Form->input('email', array('label' => 'Email: ', 'placeholder' => 'Enter your email', 'required' => 'required', 'maxlength' => 150));
				echo $this->Form->input('review',array('label' => 'Review: ', 'maxlength' => 500, 'type' => 'textarea'));
			?>
