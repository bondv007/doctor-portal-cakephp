    ...
    <?php echo $this->Form->create('BannedIp' , array('class' => 'normal', 'action' => 'update')); ?>
		...
		<table class="list">
			<tr>
				...
				<th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort('BannedIp.address', __l('Victims'));?></div></th>
				<th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort('BannedIp.reason', __l('Reason'));?></div></th>
				<th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort('BannedIp.redirect', __l('Redirect to'));?></div></th>
				<th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort('BannedIp.thetime', __l('Date Set'));?></div></th>
				<th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort('BannedIp.timespan', __l('Expiry Date'));?></div></th>
			</tr>
			<?php
			if (!empty($bannedIps)):
				$i = 0;
