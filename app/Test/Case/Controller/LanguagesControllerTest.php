...
class LanguagesControllerTest extends CmsTestCase {
    ...
    private function __testAdminMoveUp() {
        ...
        $this->assertEqual($benId, 2, __l('Could not add a new language.'));
    ...
    private function __testAdminMoveUpWithSteps() {
        ...
        $this->assertEqual($deuId, 3, __l('Could not add a new language.'));
