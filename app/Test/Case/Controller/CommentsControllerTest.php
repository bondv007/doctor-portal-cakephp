...
class CommentsControllerTest extends CmsControllerTestCase {
 ...
 */
    ...
    public function testAdminEdit() {
        ...
        $this->assertEqual($comment['Comment']['name'], 'Mr Cms [modified]');
 ...
 */
    public function testAdd() {
        ...
        $this->assertEqual($commenters, array('Mr Cms', 'John Smith'));
 ...
 */
    public function testAddWithParent() {
        ...
        $node = $Comments->Comment->Node->findBySlug('hello-world');
        $Comments->add($node['Node']['id'], 1); // under the comment by Mr Cms
        $this->assertEqual($Comments->viewVars['success'], 1);

        $comments = $Comments->Comment->generateTreeList(array('Comment.node_id' => $node['Node']['id']), '{n}.Comment.id', '{n}.Comment.name');
        $commenters = array_values($comments);
        $this->assertEqual($commenters, array('Mr Cms', '_John Smith'));
